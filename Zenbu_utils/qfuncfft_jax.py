...
from loginterp_jax import loginterp_jax
...
class QFuncFFT_JAX:
    ...
    '''
    def __init__(self, k, p, kIR = None, qv = None, oneloop = True, shear = True, third_order = True, low_ring=True):
        ...
        if qv is None:
            self.qv = jnp.logspace(-5,5,20000)
        else:
            self.qv = qv
    ...
    def setup_oneloop_2pts(self):
        ...
        # A10
        self.zerolag_10_loop12 = jnp.trapz((self.R1-self.R2)/7.,x=self.k) / (2*jnp.pi**2)
